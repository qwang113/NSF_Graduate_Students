...
exist_0_ID <- stay_dat_wide$ID[which( rowSums( stay_dat_wide[,-c(1:8)] == 0 ) != 0 )]
...
long_omit_rows <- which(stay_dat_long$ID %in% c(exist_0_ID, na_omit_rows))

stay_dat_wide_final <- stay_dat_wide[-which(stay_dat_wide$ID %in% c(exist_0_ID, na_omit_rows)),]
