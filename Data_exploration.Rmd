...
long_omit_rows <- which(stay_dat_long$ID %in% filtered_ID)
stay_dat_long <- stay_dat_long[-long_omit_rows,]



write.csv(as.data.frame(stay_dat_long), "D:/77/UCSC/study/Research/temp/NSF_dat/nsf_final_long.csv", row.names = FALSE)
