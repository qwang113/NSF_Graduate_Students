...
```{r}
use_dat <- dat$DAT[-which(dat$DAT$UNITID==999999),c("school_id","year","gss_code","ft_tot_all_races_v","long","lat")]
...
use_dat <- use_dat[tem,]
sch_gss <- paste(as.character(use_dat$school_id), as.character(use_dat$gss_code))[tem]
