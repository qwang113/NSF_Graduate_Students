...
curr_year <- 2017
train_pc <- array(cbind(0, log(nsf_y[,1:(curr_year-1972-1)]+1)), dim = c(nrow(nsf_y), curr_year-1972, 1)) # First year, all school has no pc, use 0 to hold a position
pred_pc <- array(log(nsf_y[,(curr_year-1972)]+1), dim = c(nrow(nsf_y), 1, 1))
