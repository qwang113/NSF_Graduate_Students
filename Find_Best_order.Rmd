...
for (i in c(1:length(uni_id))[-c(588,1711,1817,1818,1819,1820,1901,1904,1908)] ) {
...
college_id = as.numeric(substr(data_with_order$ID,1,6))
final_data_with_order <- as.data.frame(cbind(na.omit(order_dat), college_id))
